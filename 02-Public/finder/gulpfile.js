...
var typeRoot = {
    srcPcA : root + language.en + type.pcA + srcRoot, //typeRoot.srcPc 배포
    distPcA : root + language.en + type.pcA + distRoot //typeRoot.distPc 작업
};
...
gulp.task('pcA-html-copy', function(){htmlCopyFun({language : language.en, type : type.pcA});});
...
gulp.task('pcA-sass', function(){sassFun({language : language.en, type : type.pcA});});
...
gulp.task('pcA-script', function(){scriptFun({language: language.en, type: type.pcA});});
...
gulp.task('pcA-plugin', function(){pluginFun({language: language.en, type: type.pcA});});
...
gulp.task('pcA-image-copy', function(){imagesFun({language : language.en, type : type.pcA});});
